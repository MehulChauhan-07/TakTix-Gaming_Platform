        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="text-sm text-muted-foreground max-w-md">
              Taktix is an online multiplayer gaming platform where users can play strategic board games like Chess and
              Tic-Tac-Toe with real players around the world.
            </p>
          </div>
