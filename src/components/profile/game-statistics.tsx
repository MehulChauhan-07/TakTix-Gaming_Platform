  ...
  return (
    <div className="rounded-lg border bg-card text-card-foreground shadow-sm">
      <div className="flex flex-col space-y-1.5 p-6">
        ...
        <p className="text-sm text-muted-foreground">
          Your gaming performance across all games
        </p>
      </div>
      <div className="p-6 pt-0">
                  ...
                  <div
                    ...
                    style={{
                      clipPath: `polygon(50% 50%, 50% 0%, ${
                        ...
                        50 *
                          Math.cos(
                            (stats.wins / stats.totalGames) * Math.PI * 2
                          )
                      }% ${
                        50 -
                        50 *
                  ...
                  <div
                    ...
                    style={{
                      clipPath: `polygon(50% 50%, ${
                        ...
                        50 *
                          Math.cos(
                            ((stats.wins + stats.losses) / stats.totalGames) *
                              Math.PI *
                              2
                          )
                      }% ${
                  ...
                  {stats.recentPerformance.map((month, index) => (
                    ...
                    >
                      <div className="w-full flex flex-col-reverse">
                        <div
                          className="bg-green-500 h-[1px]"
                          style={{ height: `${(month.wins / 5) * 100}px` }}
                        ></div>
                        <div
                          className="bg-red-500 h-[1px]"
                          style={{ height: `${(month.losses / 5) * 100}px` }}
                        ></div>
                        <div
                          className="bg-amber-500 h-[1px]"
                          style={{ height: `${(month.draws / 5) * 100}px` }}
                        ></div>
                      </div>
          ...
          <TabsContent value="tic-tac-toe" className="mt-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="bg-card border rounded-lg p-4 text-center">
                ...
                <p className="text-2xl font-bold">
                  {stats.ticTacToeStats.totalGames}
                </p>
              </div>
              <div className="bg-card border rounded-lg p-4 text-center">
                <h3 className="text-sm font-medium text-muted-foreground mb-1">
